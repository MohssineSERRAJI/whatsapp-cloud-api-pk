...
const startExpressServer = (options) =>
  new Promise((resolve) => {
    const app =
      (options === null || options === void 0 ? void 0 : options.app) ||
      (0, express_1.default)();
    app.use(express_1.default.json());
    if (
      options === null || options === void 0 ? void 0 : options.useMiddleware
    ) {
      options.useMiddleware(app);
    }
    const webhookPath =
      (options === null || options === void 0 ? void 0 : options.webhookPath) ||
      "/webhook/whatsapp";
    if (
    ...
    app.post(webhookPath, async (req, res) => {
      ...
      if (
        ...
        !((_d =
          (_c =
            (_b =
              (_a = req.body.entry) === null || _a === void 0
                ? void 0
                : _a[0]) === null || _b === void 0
              ? void 0
              : _b.changes) === null || _c === void 0
            ? void 0
            : _c[0]) === null || _d === void 0
          ? void 0
          : _d.value)
              ...
              (_g =
                (_f =
                  (_e = req.body) === null || _e === void 0
                    ? void 0
                    : _e.entry) === null || _f === void 0
                  ? void 0
                  : _f[0]) === null || _g === void 0
                ? void 0
                : _g.changes) === null || _h === void 0
              ? void 0
              : _h[0]) === null || _j === void 0
            ? void 0
      ...
      switch (type) {
        case "text":
          ...
          data = {
            text: (_l = rest.text) === null || _l === void 0 ? void 0 : _l.body,
          };
          break;
        case "image":
        case "document":
      ...
      if (event && data) {
        ["message", event].forEach((e) =>
          pubsub_js_1.default.publish(e, {
            from,
            id,
            timestamp,
            type: event,
    ...
    const port =
      (options === null || options === void 0 ? void 0 : options.port) || 3000;
